Attribute VB_Name = "Mdl_Timesheet"
Option Explicit

Sub Demo_Timesheet()
    Dim hol As Object
    
    Set hol = VBL_Cal_BuildHolidayDict(Worksheets("Holidays").Range("A1:A400"))
    Call VBL_TS_CreateMonthlySheet(2026, 2, False, hol)
...
Public Sub VBL_TS_CreateMonthlySheet( _
    ...
    Optional ByVal holidayDict As Object = Nothing)
    Dim wb As Workbook
    Dim ws As Worksheet
