Attribute VB_Name = "Mdl_Test_AppRuntime"
Option Explicit

'========================
' Tests for Mdl_AppRuntime
'========================
'・TimeoutMsは境界値（0/600000)と異常値（-1/600001)をテスト
'・例外テストはAssertRaisesの都合上、例外を出すだけのラッパーSubを用意
'・PerfEnter/Leaveは変更されたこと と 元に戻ること を両方確認
...
Public Sub Call_SetTimeout_Negative()
    Mdl_AppRuntime.VBL_TimeoutMs (-1)
End Sub


Public Sub Test_TimeoutMs_RejectOverMax()
'    Mdl_Assert.AssertRaises vbObjectError + 1001, "Mdl_Test_AppRuntime._Call_SetTimeout_OverMax"
End Sub

Public Sub Call_SetTimeout_OverMax()
